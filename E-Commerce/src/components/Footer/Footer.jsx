          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 col-span-2 md:pl-10">
            ...
            <div>
              <div className="flex items-center gap-3 mt-6">
                <a href="#" className="social-link hover:text-[#e1306c] transition-all duration-300 ease-in-out">
                  <FaInstagram className="text-3xl" />
                </a>
                <a href="#" className="social-link hover:text-[#1877f2] transition-all duration-300 ease-in-out">
                ...
                <a href="#" className="social-link hover:text-gray-700 transition-all duration-300 ease-in-out">
